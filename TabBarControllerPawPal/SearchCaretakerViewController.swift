...
class SearchCaretakerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let caretaker2 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
        caretakerList.append(caretaker2)
        let caretaker3 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
        caretakerList.append(caretaker3)
        let caretaker4 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
        caretakerList.append(caretaker4)
        let caretaker5 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
        caretakerList.append(caretaker5)
        let caretaker6 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
        caretakerList.append(caretaker6)
        let caretaker7 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
        caretakerList.append(caretaker7)
        let caretaker8 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
        caretakerList.append(caretaker8)
        let caretaker9 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
        caretakerList.append(caretaker9)
        let caretaker10 = CaretakerData(name: "Katie", price: "Price : Rs 350 / Day", address: "2.7 km, Chennai", rating: "Frame 166", isverified: true, caretakerImage: "Profile Image 1")
